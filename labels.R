...
coicop_full_context <- "COICOP: BREAKDOWN OF INDIVIDUAL CONSUMPTION EXPENDITURE OF HOUSEHOLDS BY DIVISION AND GROUP
01 FOOD AND NON-ALCOHOLIC BEVERAGES
01.1 FOOD
...
12.7 OTHER SERVICES N.E.C.COICOP: DEFINITION BY CLASS
01–12 INDIVIDUAL CONSUMPTION EXPENDITURE OF HOUSEHOLDS
01 FOOD AND NON-ALCOHOLIC BEVERAGES
01.1 FOOD
The food products classified here are those
purchased for consumption at home. The
group excludes: food products sold for
immediate consumption away from the home
by hotels, restaurants, cafe´s, bars, kiosks, street
vendors, automatic vending machines, etc.
(11.1.1); cooked dishes prepared by restaurants
for consumption off their premises (11.1.1);
cooked dishes prepared by catering contractors
whether collected by the customer or delivered
to the customer’s home (11.1.1); and products
sold specifically as pet foods (09.3.4).
01.1.1 Bread and cereals (ND)
– Rice in all forms;
– maize, wheat, barley, oats, rye and other cereals in the form of grain, flour or meal;
– bread and other bakery products (crispbread,
rusks, toasted bread, biscuits, gingerbread,
wafers, waffles, crumpets, muffins, croissants,
cakes, tarts, pies, quiches, pizzas, etc.);
– mixes and doughs for the preparation of
bakery products;
– pasta products in all forms; couscous;
– cereal preparations (cornflakes, oatflakes,
etc.) and other cereal products (malt, malt
flour, malt extract, potato starch, tapioca,
sago and other starches).
Includes: farinaceous-based products prepared
with meat, fish, seafood, cheese, vegetables or
fruit.
Excludes: meat pies (01.1.2); fish pies (01.1.3);
sweetcorn (01.1.7).
01.1.2 Meat (ND)
...
guinea fowl);
- hare, rabbit and game (antelope, deer,
boar, pheasant, grouse, pigeon, quail,
etc.);
– fresh, chilled or frozen edible offal;
– dried, salted or smoked meat and edible offal
(sausages, salami, bacon, ham, paˆte´, etc.);
– other preserved or processed meat and meatbased preparations (canned meat, meat
extracts, meat juices, meat pies, etc.).
Includes: meat and edible offal of marine
mammals (seals, walruses, whales, etc.) and
exotic animals (kangaroo, ostrich, alligator,
etc.); animals and poultry purchased live for
consumption as food.
Excludes: land and sea snails (01.1.3); lard and
other edible animal fats (01.1.5); soups, broths
and stocks containing meat (01.1.9).
01.1.3 Fish and seafood (ND)
– Fresh, chilled or frozen fish;
– fresh, chilled or frozen seafood (crustaceans,
molluscs and other shellfish, sea snails);
– dried, smoked or salted fish and seafood;
– other preserved or processed fish and seafood and fish and seafood-based preparations (canned fish and seafood, caviar and
other hard roes, fish pies, etc.).
Includes: land crabs, land snails and frogs; fish
and seafood purchased live for consumption as
food.
Excludes: soups, broths and stocks containing
fish and seafood (01.1.9).
...
eggs.
Includes: milk, cream and yoghurt containing
sugar, cocoa, fruit or flavourings; dairy products not based on milk such as soya milk.
Excludes: butter and butter products (01.1.5).
01.1.5 Oils and fats (ND)
– Butter and butter products (butter oil, ghee,
etc.);
– margarine (including ‘‘diet’’ margarine) and
other vegetable fats (including peanut butter);
– edible oils (olive oil, corn oil, sunflower-seed
oil, cottonseed oil, soybean oil, groundnut
oil, walnut oil, etc.);
...
such as aubergines, cucumbers and tomatoes
(01.1.7); jams, marmalades, compotes, jellies,
fruit pure´es and pastes (01.1.8); parts of plants
preserved in sugar (01.1.8); fruit juices and
syrups (01.2.2).
01.1.7 Vegetables (ND)
– Fresh, chilled, frozen or dried vegetables
cultivated for their leaves or stalks (asparagus, broccoli, cauliflower, endives, fennel,
spinach, etc.), for their fruit (aubergines,
cucumbers, courgettes, green peppers,
pumpkins, tomatoes, etc.), and for their
roots (beetroots, carrots, onions, parsnips,
radishes, turnips, etc.);
– fresh or chilled potatoes and other tuber
vegetables (manioc, arrowroot, cassava,
sweet potatoes, etc.);
– preserved or processed vegetables and vegetable-based products;
Note: ND, SD, D and S denote non-durable goods, semi-durable
goods, durable goods and services, respectively.
– products of tuber vegetables (flours, meals,
flakes, pure´es, chips and crisps) including
frozen preparations such as chipped potatoes.
Includes: olives; garlic; pulses; sweetcorn; sea
fennel and other edible seaweed; mushrooms
and other edible fungi.
Excludes: potato starch, tapioca, sago and
other starches (01.1.1); soups, broths and
stocks containing vegetables (01.1.9); culinary
herbs (parsley, rosemary, thyme, etc.) and spices (pepper, pimento, ginger, etc.) (01.1.9);
vegetable juices (01.2.2).
01.1.8 Sugar, jam, honey, chocolate and confectionery
(ND)
– Cane or beet sugar, unrefined or refined,
powdered, crystallized or in lumps;
– jams, marmalades, compotes, jellies, fruit
pure´es and pastes, natural and artificial
honey, maple syrup, molasses and parts of
plants preserved in sugar;
– chocolate in bars or slabs, chewing gum,
sweets, toffees, pastilles and other confectionery products;
– cocoa-based foods and cocoa-based dessert
preparations;
– edible ice, ice cream and sorbet.
Includes: artificial sugar substitutes.
Excludes: cocoa and chocolate-based powder
(01.2.1).
01.1.9 Food products n.e.c. (ND)
– Salt, spices (pepper, pimento, ginger, etc.),
culinary herbs (parsley, rosemary, thyme,
etc.), sauces, condiments, seasonings (mustard, mayonnaise, ketchup, soy sauce, etc.),
vinegar;
– prepared baking powders, baker’s yeast,
dessert preparations, soups, broths, stocks,
culinary ingredients, etc.;
– homogenized baby food and dietary preparations irrespective of the composition.
Excludes: milk-based desserts (01.1.4); soya
milk (01.1.4); artificial sugar substitutes
(01.1.8); cocoa-based dessert preparations
(01.1.8).
01.2 NON-ALCOHOLIC BEVERAGES
The non-alcoholic beverages classified here
are those purchased for consumption at home.
The group excludes non-alcoholic beverages
sold for immediate consumption away from
the home by hotels, restaurants, cafe´s, bars,
kiosks, street vendors, automatic vending
machines, etc. (11.1.1).
01.2.1 Coffee, tea and cocoa (ND)
– Coffee, whether or not decaffeinated, roasted
or ground, including instant coffee;
– tea, mate´ and other plant products for
infusions;
– cocoa, whether or not sweetened, and chocolate-based powder.
Includes: cocoa-based beverage preparations;
coffee and tea substitutes; extracts and essences
of coffee and tea.
Excludes: chocolate in bars or slabs (01.1.8);
cocoa-based food and cocoa-based dessert
preparations (01.1.8).
01.2.2 Mineralwaters, soft drinks, fruit and vegetable
juices (ND)
– Mineral or spring waters; all drinking water
sold in containers;
– soft drinks such as sodas, lemonades and
colas;
– fruit and vegetable juices;
– syrups and concentrates for the preparation
of beverages.
...
AND NARCOTICS
02.1 ALCOHOLIC BEVERAGES
The alcoholic beverages classified here are
those purchased for consumption at home. The
group excludes alcoholic beverages sold for
immediate consumption away from the home
by hotels, restaurants, cafe´s, bars, kiosks, street
vendors, automatic vending machines, etc.
(11.1.1).
The beverages classified here include low- or
non-alcoholic beverages which are generally
alcoholic such as non-alcoholic beer.
02.1.1 Spirits (ND)
– Eaux-de-vie, liqueurs and other spirits.
Includes: mead; aperitifs other than wine-based
aperitifs (02.1.2).
02.1.2 Wine (ND)
– Wine, cider and perry, including sake;
– wine-based aperitifs, fortified wines, champagne and other sparkling wines.
02.1.3 Beer (ND)
– All kinds of beer such as ale, lager and
porter.
Includes: low-alcoholic beer and non-alcoholic
beer; shandy.
02.2 TOBACCO
This group covers all purchases of tobacco by
households, including purchases of tobacco in
restaurants, cafe´s, bars, service stations, etc.
02.2.0 Tobacco (ND)
– Cigarettes; cigarette tobacco and cigarette
papers;
– cigars, pipe tobacco, chewing tobacco or
snuff.
Excludes: other smokers’ articles (12.3.2).
02.3 NARCOTICS
02.3.0 Narcotics (ND)
– Marijuana, opium, cocaine and their derivatives;
– other vegetable-based narcotics such as cola
nuts, betel leaves and betel nuts;
– other narcotics including chemicals and
man-made drugs.
03 CLOTHING AND FOOTWEAR
03.1 CLOTHING
03.1.1 Clothing materials (SD)
– Clothing materials of natural fibres, of manmade fibres and of their mixtures.
Excludes: furnishing fabrics (05.2.0).
03.1.2 Garments (SD)
– Garments for men, women, children (3 to 13
years) and infants (0 to 2 years), either
ready-to-wear or made-to-measure, in all
materials (including leather, furs, plastics
and rubber), for everyday wear, for sport or
for work:
- capes, overcoats, raincoats, anoraks, parkas, blousons, jackets, trousers, waistcoats, suits, costumes, dresses, skirts, etc.;
- shirts, blouses, pullovers, sweaters, cardigans, shorts, swimsuits, tracksuits, jogging
suits, sweatshirts, T-shirts, leotards, etc.;
- vests, underpants, socks, stockings, tights,
petticoats, brassie`res, knickers, slips, girdles, corsets, body stockings, etc.;
- pyjamas, nightshirts, nightdresses, housecoats, dressing gowns, bathrobes, etc.;
- baby clothes and babies’ booties made of
fabric.
Excludes: articles of medical hosiery such as
elasticated stockings (06.1.2); babies’ napkins
(12.1.3).
03.1.3 Other articles of clothing and clothing accessories (SD)
– Ties, handkerchiefs, scarves, squares, gloves,
mittens, muffs, belts, braces, aprons, smocks,
bibs, sleeve protectors, hats, caps, berets,
bonnets, etc.;
– sewing threads, knitting yarns and accessories for making clothing such as buckles,
buttons, press studs, zip fasteners, ribbons,
laces, trimmings, etc.
...
rubber (05.6.1); pins, safety pins, sewing needles, knitting needles, thimbles (05.6.1); protective headgear for sports (09.3.2); other protective gear for sports such as life jackets,
boxing gloves, body padding, belts, supports,
etc. (09.3.2); paper handkerchiefs (12.1.3);
watches, jewellery, cuff links, tiepins (12.3.1);
walking sticks and canes, umbrellas and parasols, fans, keyrings (12.3.2).
...
garments;
– hire of garments.
Includes: total value of the repair service (that
is, both the cost of labour and the cost of
materials are covered).
Excludes: materials, threads, accessories, etc.
...
household textiles (05.2.0); dry-cleaning, laundering, dyeing and hiring of household linen
and other household textiles (05.6.2).
03.2 FOOTWEAR
03.2.1 Shoes and other footwear (SD)
– All footwear for men, women, children (3 to
13 years) and infants (0 to 2 years) including
sports footwear suitable for everyday or leisure wear (shoes for jogging, cross-training,
tennis, basket ball, boating, etc.).
Includes: gaiters, leggings and similar articles;
shoelaces; parts of footwear, such as heels,
soles, etc., purchased by households with the
intention of repairing footwear themselves.
Excludes: babies’ booties made of fabric
(03.1.2); shoe-trees, shoehorns and polishes,
creams and other shoe-cleaning articles
(05.6.1); orthopaedic footwear (06.1.3); gamespecific footwear (ski boots, football boots,
golfing shoes and other such footwear fitted
with ice-skates, rollers, spikes, studs, etc.)
(09.3.2); shin-guards, cricket pads and other
such protective apparel for sport (09.3.2).
...
is, both the cost of labour and the cost of
materials are covered).
Excludes: parts of footwear, such as heels,
soles, etc., purchased by households with the
intention of undertaking the repair themselves
(03.2.1); polishes, creams and other shoecleaning articles (05.6.1); repair (09.3.2) or hire
(09.4.1) of game-specific footwear (ski boots,
football boots, golfing shoes and other such
footwear fitted with ice-skates, rollers, spikes,
studs, etc.).
04 HOUSING, WATER, ELECTRICITY, GAS
AND OTHER FUELS
04.1 ACTUAL RENTALS FOR HOUSING
Rentals normally include payment for the
use of the land on which the property stands,
the dwelling occupied, the fixtures and fittings
for heating, plumbing, lighting, etc., and, in the
case of a dwelling let furnished, the furniture.
Rentals also include payment for the use of a
garage to provide parking in connection with
the dwelling. The garage does not have to be
physically contiguous to the dwelling; nor does
it have to be leased from the same landlord.
Rentals do not include payment for the use
of garages or parking spaces not providing
parking in connection with the dwelling
(07.2.4). Nor do they include charges for water
supply (04.4.1), refuse collection (04.4.2) and
sewage collection (04.4.3); co-proprietor charges for caretaking, gardening, stairwell cleaning, heating and lighting, maintenance of lifts
and refuse disposal chutes, etc. in multi-occupied buildings (04.4.4); charges for electricity
(04.5.1) and gas (04.5.2); charges for heating
and hot water supplied by district heating
plants (04.5.5).
04.1.1 Actualrentals paid by tenants (S)
– Rentals actually paid by tenants or subtenants occupying unfurnished or furnished
premises as their main residence.
Includes: payments by households occupying a
room in a hotel or boarding house as their
main residence.
Excludes: accommodation services of educational establishments and hostels (11.2.0) and
of retirement homes for elderly persons
(12.4.0).
04.1.2 Other actualrentals (S)
– Rentals actually paid for secondary residences.
Excludes: accommodation services of holiday
villages and holiday centres (11.2.0).
04.2 IMPUTED RENTALS FOR HOUSING
For coverage see note to (04.1) above.
04.2.1 Imputed rentals of owner-occupiers (S)
– Imputed rentals of owners occupying their
main residence.
04.2.2 Other imputed rentals (S)
– Imputed rentals for secondary residences;
– imputed rentals of households paying a
reduced rental or housed free.
04.3 MAINTENANCE AND REPAIR OF THE
DWELLING
Maintenance and repair of dwellings are
distinguished by two features: first, they are
activities that have to be undertaken regularly
in order to maintain the dwelling in good
working order; second, they do not change the
dwelling’s performance, capacity or expected
service life.
There are two types of maintenance and
repair of dwellings: those which are minor,
such as interior decoration and repairs to fittings, and which are commonly carried out by
both tenants and owners; and those which are
major, such as replastering walls or repairing
roofs, and which are carried out by owners
only.
Only expenditures which tenants and owneroccupiers incur on materials and services for
minor maintenance and repair are part of
individual consumption expenditure of households. Expenditures which owner-occupiers
incur on materials and services for major
maintenance and repair are not part of individual consumption expenditure of households.
Purchases of materials made by tenants or
owner-occupiers with the intention of undertaking the maintenance or repair themselves
should be shown under (04.3.1). If tenants or
owner-occupiers pay an enterprise to carry out
the maintenance or repair, the total value of
the service, including the costs of the materials
used, should be shown under (04.3.2).
04.3.1 Materials for the maintenance and repair of the
dwelling (ND)
– Products and materials, such as paints and
varnishes, renderings, wallpapers, fabric wall
coverings, window panes, plaster, cement,
putty, wallpaper pastes, etc., purchased for
minor maintenance and repair of the dwelling.
Includes: small plumbing items (pipes, taps,
joints, etc.), surfacing materials (floorboards,
ceramic tiles, etc.) and brushes and scrapers for
paint, varnish and wallpaper.
Excludes: fitted carpets and linoleum (05.1.2);
hand tools, door fittings, power sockets, wiring
flex and lamp bulbs (05.5.2); brooms, scrubbing brushes, dusting brushes and cleaning
products (05.6.1); products, materials and fixtures used for major maintenance and repair
(intermediate consumption) or for extension
and conversion of the dwelling (capital formation).
04.3.2 Services for the maintenance and repair of the
dwelling (S)
– Services of plumbers, electricians, carpenters, glaziers, painters, decorators, floor
polishers, etc. engaged for minor maintenance and repair of the dwelling.
Includes: total value of the service (that is, both
the cost of labour and the cost of materials are
covered).
Excludes: separate purchases of materials
made by households with the intention of
undertaking the maintenance or repair themselves (04.3.1); services engaged for major
maintenance and repair (intermediate consumption) or for extension and conversion of
the dwelling (capital formation).
...
containers (01.2.2); hot water or steam purchased from district heating plants (04.5.5).
...
04.4.4 Other services relating to the dwelling
n.e.c. (S)
– Co-proprietor charges for caretaking, gardening, stairwell cleaning, heating and
lighting, maintenance of lifts and refuse
disposal chutes, etc. in multi-occupied
buildings;
– security services;
– snow removal and chimney sweeping.
Excludes: household services such as window
cleaning, disinfecting, fumigation and pest
extermination (05.6.2); bodyguards (12.7.0).
04.5 ELECTRICITY, GAS AND OTHER FUELS
...
etc.).
Includes: associated expenditure such as hire of
meters, reading of meters, storage containers,
...
Includes: associated expenditure such as hire of
meters, reading of meters, standing charges,
etc.; ice used for cooling and refrigeration
purposes.
...
– lighting equipment such as ceiling lights,
standard lamps, globe lights and bedside
lamps;
– pictures, sculptures, engravings, tapestries
and other art objects including reproductions of works of art and other ornaments;
– screens, folding partitions and other furniture and fixtures.
Includes: delivery and installation when
applicable; base mattresses, mattresses, tatamis; bathroom cabinets; baby furniture such as
cradles, high chairs and playpens; blinds;
camping and garden furniture; mirrors, candleholders and candlesticks.
Excludes: bedding and sunshades (05.2.0); safes
(05.3.1); ornamental glass and ceramic articles
(05.4.0); clocks (12.3.1); wall thermometers and
barometers (12.3.2); carrycots and pushchairs
...
– Loose carpets, fitted carpets, linoleum and
other such floor coverings.
Includes: laying of floor coverings.
Excludes: bathroom mats, rush mats and
doormats (05.2.0); antique floor coverings
acquired primarily as stores of value (capital
formation).
...
Includes: total value of the service (that is, both
the cost of labour and the cost of materials are
covered); restoration of works of art, antique
furniture and antique floor coverings other
than those acquired primarily as stores of value
(capital formation).
Excludes: separate purchases of materials made
by households with the intention of undertaking the repair themselves (05.1.1) or
(05.1.2); dry-cleaning of carpets (05.6.2).
05.2 HOUSEHOLD TEXTILES
...
hammocks;
– bedlinen such as sheets, pillowcases, blankets, travelling rugs, plaids, eiderdowns,
counterpanes and mosquito nets;
– table linen and bathroom linen such as
tablecloths, table napkins, towels and face
cloths;
– other household textiles such as shopping
bags, laundry bags, shoe bags, covers for
clothes and furniture, flags, sunshades, etc.;
– repair of such articles.
Includes: cloth bought by the piece; oilcloth;
bathroom mats, rush mats and doormats.
Excludes: fabric wall coverings (04.3.1); tapestries (05.1.1); floor coverings such as carpets
and fitted carpets (05.1.2); electric blankets
(05.3.2); covers for motor cars, motorcycles,
etc. (07.2.1); air mattresses and sleeping bags
(09.3.2).
05.3 HOUSEHOLD APPLIANCES
...
– cookers, spit roasters, hobs, ranges, ovens
and microwave ovens;
– air-conditioners, humidifiers, space heaters,
water heaters, ventilators and extractor
hoods;
– vacuum cleaners, steam-cleaning machines,
carpet shampooing machines and machines
for scrubbing, waxing and polishing floors;
– other major household appliances such as
safes, sewing machines, knitting machines,
water softeners, etc.
Includes: delivery and installation of the
appliances when applicable.
Excludes: such appliances that are built into
the structure of the building (capital formation).
05.3.2 Small electric household appliances (SD)
– Coffee mills, coffee-makers, juice extractors,
can-openers, food mixers, deep fryers, meat
grills, knives, toasters, ice cream makers,
sorbet makers, yoghurt makers, hotplates,
irons, kettles, fans, electric blankets, etc.
Excludes: small non-electric household articles
and kitchen utensils (05.4.0); household scales
(05.4.0); personal weighing machines and baby
scales (12.1.3).
05.3.3 Repair of household appliances (S)
– Repair of household appliances.
Includes: total value of the service (that is, both
the cost of labour and the cost of materials are
covered); charges for the leasing or rental of
major household appliances.
Excludes: separate purchases of materials made
by households with the intention of undertaking the repair themselves (05.3.1) or
(05.3.2).
05.4 GLASSWARE, TABLEWARE AND
HOUSEHOLD UTENSILS
05.4.0 Glassware, tableware and household utensils (SD)
– Glassware, crystal ware, ceramic ware and
china ware of the kind used for table,
kitchen, bathroom, toilet, office and indoor
decoration;
– cutlery, flatware and silverware;
– non-electric kitchen utensils of all materials
such as saucepans, stewpots, pressure cookers, frying pans, coffee mills, pure´e makers,
mincers, hotplates, household scales and
other such mechanical devices;
– non-electric household articles of all materials such as containers for bread, coffee,
spices, etc., waste bins, waste-paper baskets,
laundry baskets, portable money boxes and
strongboxes, towel rails, bottle racks, irons
and ironing boards, letter boxes, feeding
bottles, thermos flasks and iceboxes;
– repair of such articles.
Excludes: lighting equipment (05.1.1); electric
household appliances (05.3.1) or (05.3.2);
cardboard tableware (05.6.1); personal weighing machines and baby scales (12.1.3); ashtrays
(12.3.2).
05.5 TOOLS AND EQUIPMENT FOR
HOUSE AND GARDEN
05.5.1 Major tools and equipment (D)
– Motorized tools and equipment such as
electric drills, saws, sanders and hedge cutters, garden tractors, lawnmowers, cultivators, chainsaws and water pumps;
– repair of such articles.
Includes: charges for the leasing or rental of doit-yourself machinery and equipment.
05.5.2 Small tools and miscellaneous accessories (SD)
– Hand tools such as saws, hammers, screwdrivers, wrenches, spanners, pliers, trimming
knives, rasps and files;
– garden tools such as wheelbarrows, watering
cans, hoses, spades, shovels, rakes, forks,
scythes, sickles and secateurs;
– ladders and steps;
– door fittings (hinges, handles and locks),
fittings for radiators and fireplaces, other
metal articles for the house (curtain rails,
carpet rods, hooks, etc.) or for the garden
(chains, grids, stakes and hoop segments for
fencing and bordering);
– small electric accessories such as power
sockets, switches, wiring flex, electric bulbs,
fluorescent lighting tubes, torches, flashlights, hand lamps, electric batteries for
general use, bells and alarms;
– repair of such articles.
...
scouring powders, detergents, disinfectant
bleaches, softeners, conditioners, windowcleaning products, waxes, polishes, dyes,
unblocking agents, disinfectants, insecticides, pesticides, fungicides and distilled
water;
– articles for cleaning such as brooms, scrubbing brushes, dustpans and dust brushes,
dusters, tea towels, floorcloths, household
sponges, scourers, steel wool and chamois
leathers;
– paper products such as filters, tablecloths
and table napkins, kitchen paper, vacuum
cleaner bags and cardboard tableware,
including aluminium foil and plastic bin
liners;
– other non-durable household articles such as
matches, candles, lamp wicks, methylated
spirits, clothes-pegs, clothes hangers, pins,
safety pins, sewing needles, knitting needles,
thimbles, nails, screws, nuts and bolts, tacks,
washers, glues and adhesive tapes for
household use, string, twine and rubber
gloves.
Includes: polishes, creams and other shoecleaning articles; fire extinguishers for households.
Excludes: brushes and scrapers for paint, varnish and wallpaper (04.3.1); fire extinguishers
for transport equipment (07.2.1); products
specifically for the cleaning and maintenance of
transport equipment such as paints, chrome
cleaners, sealing compounds and bodywork
polishes (07.2.1); horticultural products for the
upkeep of ornamental gardens (09.3.3); paper
handkerchiefs, toilet paper, toilet soaps, toilet
sponges and other products for personal
hygiene (12.1.3); cigarette, cigar and pipe
lighters and lighter fuel (12.3.2).
...
– similar services, including babysitting and
housework, supplied by enterprises or selfemployed persons;
– household services such as window cleaning,
disinfecting, fumigation and pest extermination;
– dry-cleaning, laundering and dyeing of
household linen, household textiles and
carpets;
– hire of furniture, furnishings, carpets,
...
cleaning, heating and lighting, maintenance of
lifts and refuse disposal chutes, etc. in multioccupied buildings (04.4.4); security services
(04.4.4); snow removal and chimney sweeping
(04.4.4); removal and storage services (07.3.6);
services of wet-nurses, cre`ches, day-care centres
and other child-minding facilities (12.4.0);
bodyguards (12.7.0).
06 HEALTH
This division also includes health services
purchased from school and university health
centres.
06.1 MEDICAL PRODUCTS, APPLIANCES
AND EQUIPMENT
This group covers medicaments, prostheses,
medical appliances and equipment and other
health-related products purchased by individuals or households, either with or without a
...
outside a health facility or institution. Such
products supplied directly to outpatients by
medical, dental and paramedical practitioners
or to in-patients by hospitals and the like are
included in outpatient services (06.2) or hospital services (06.3).
06.1.1 Pharmaceuticalproducts (ND)
– Medicinal preparations, medicinal drugs,
patent medicines, serums and vaccines,
vitamins and minerals, cod liver oil and
halibut liver oil, oral contraceptives.
Excludes: veterinary products (09.3.4); articles
for personal hygiene such as medicinal soaps
(12.1.3).
06.1.2 Other medicalproducts (ND)
– Clinical thermometers, adhesive and nonadhesive bandages, hypodermic syringes,
first-aid kits, hot-water bottles and ice bags,
medical hosiery items such as elasticated
stockings and knee supports, pregnancy
tests, condoms and other mechanical contraceptive devices.
06.1.3 Therapeutic appliances and equipment (D)
– Corrective eyeglasses and contact lenses,
hearing aids, glass eyes, artificial limbs and
other prosthetic devices, orthopaedic braces
and supports, orthopaedic footwear, surgical
belts, trusses and supports, neck braces,
medical massage equipment and health
lamps, powered and unpowered wheelchairs
and invalid carriages, ‘‘special’’ beds, crutches, electronic and other devices for monitoring blood pressure, etc.;
– repair of such articles.
Includes: dentures but not fitting costs.
Excludes: hire of therapeutic equipment
(06.2.3); protective goggles, belts and supports
for sport (09.3.2); sunglasses not fitted with
corrective lenses (12.3.2).
06.2 OUTPATIENT SERVICES
This group covers medical, dental and
paramedical services delivered to outpatients
by medical, dental and paramedical practitioners and auxiliaries. The services may be
delivered at home, in individual or group
consulting facilities, dispensaries or the outpatient clinics of hospitals and the like.
Outpatient services include the medicaments,
prostheses, medical appliances and equipment
and other health-related products supplied
directly to outpatients by medical, dental and
paramedical practitioners and auxiliaries.
Medical, dental and paramedical services
provided to in-patients by hospitals and the
like are included in hospital services (06.3).
06.2.1 Medicalservices (S)
– Consultations of physicians in general or
specialist practice.
Includes: services of orthodontic specialists.
Excludes: services of medical analysis laboratories and x-ray centres (06.2.3); services of
practitioners of traditional medicine (06.2.3).
06.2.2 Dentalservices (S)
– Services of dentists, oral hygienists and other
dental auxiliaries.
Includes: fitting costs of dentures.
Excludes: dentures (06.1.3); services of orthodontic specialists (06.2.1); services of medical
analysis laboratories and x-ray centres (06.2.3).
06.2.3 Paramedicalservices (S)
– Services of medical analysis laboratories and
x-ray centres;
– services of freelance nurses and midwives;
– services of freelance acupuncturists, chiropractors, optometrists, physiotherapists,
...
Includes: services of practitioners of traditional
medicine.
06.3 HOSPITAL SERVICES
Hospitalization is defined as occurring when
a patient is accommodated in a hospital for the
duration of the treatment. Hospital day-care
and home-based hospital treatment are included, as are hospices for terminally ill persons.
...
convalescent homes which chiefly provide inpatient health care, the services of institutions
serving old people in which medical monitoring
is an essential component and the services of
rehabilitation centres providing in-patient
health care and rehabilitative therapy where
the objective is to treat the patient rather than
to provide long-term support.
Hospitals are defined as institutions which
offer in-patient care under direct supervision of
qualified medical doctors. Medical centres,
maternity centres, nursing homes and convalescent homes also provide in-patient care
but their services are supervised and frequently
delivered by staff of lower qualification than
medical doctors.
This group does not cover the services of
facilities, such as surgeries, clinics and dispensaries, devoted exclusively to outpatient
care (06.2). Nor does it include the services of
retirement homes for elderly persons, institutions for disabled persons and rehabilitation
centres providing primarily long-term support
(12.4).
06.3.0 Hospitalservices (S)
– Hospital services comprise the provision of
the following services to hospital in-patients:
- basic services: administration; accommodation; food and drink; supervision
and care by non-specialist staff (nursing
auxiliaries); first aid and resuscitation;
ambulance transport; provision of medicines and other pharmaceutical products;
provision of therapeutic appliances and
equipment;
- medical services: services of physicians in
general or specialist practice, of surgeons
and of dentists; medical analyses and xrays; paramedical services such as those of
nurses, midwives, chiropractors, optometrists, physiotherapists, speech therapists, etc.
07TRANSPORT
07.1 PURCHASE OF VEHICLES
Purchases of recreational vehicles such as
camper vans, caravans, trailers, aeroplanes and
boats are covered by (09.2.1).
07.1.1 Motor cars (D)
– Motor cars, passenger vans, station wagons,
estate cars and the like with either two-wheel
drive or four-wheel drive.
Excludes: invalid carriages (06.1.3); camper
vans (09.2.1); golf carts (09.2.1).
07.1.2 Motor cycles (D)
– Motor cycles of all types, scooters and
powered bicycles.
Includes: sidecars; snowmobiles.
Excludes: invalid carriages (06.1.3); golf carts
(09.2.1).
07.1.3 Bicycles (D)
...
Includes: animals required to draw the vehicles
and related equipment (yokes, collars, harnesses, bridles, reins, etc.).
Excludes: horses and ponies, horse- or ponydrawn vehicles and related equipment purchased for recreational purposes (09.2.1).
07.2 OPERATION OF PERSONAL TRANSPORT EQUIPMENT
Purchases of spare parts, accessories or
lubricants made by households with the intention of undertaking the maintenance, repair or
intervention themselves should be shown under
(07.2.1) or (07.2.2). If households pay an
enterprise to carry out the maintenance, repair
or fitting, the total value of the service,
including the costs of the materials used,
should be shown under (07.2.3).
07.2.1 Spare parts and accessories for personaltransport equipment (SD)
– Tyres (new, used or retreaded), inner tubes,
spark plugs, batteries, shock absorbers, filters, pumps and other spare parts or accessories for personal transport equipment.
Includes: fire extinguishers for transport
equipment; products specifically for the cleaning and maintenance of transport equipment
such as paints, chrome cleaners, sealing compounds and bodywork polishes; covers for
motor cars, motorcycles, etc.
Excludes: crash helmets for motorcycles and
bicycles (03.1.3); non-specific products for
cleaning and maintenance such as distilled
water, household sponges, chamois leathers,
detergents, etc. (05.6.1); charges for the fitting
of spare parts and accessories and for the
painting, washing and polishing of bodywork
(07.2.3); radio-telephones (08.2.0); car radios
(09.1.1); baby seats for cars (12.3.2).
07.2.2 Fuels and lubricants for personal transport
equipment (ND)
– Petrol and other fuels such as diesel, liquid
petroleum gas, alcohol and two-stroke mixtures;
– lubricants, brake and transmission fluids,
coolants and additives.
Includes: fuel for major tools and equipment
covered under (05.5.1) and recreational vehicles covered under (09.2.1).
Excludes: charges for oil changes and greasing
(07.2.3).
07.2.3 Maintenance and repair of personaltransport
equipment (S)
– Services purchased for the maintenance and
repair of personal transport equipment such
as fitting of parts and accessories, wheel
balancing, technical inspection, breakdown
services, oil changes, greasing and washing.
Includes: total value of the service (that is, both
the cost of labour and the cost of materials are
covered).
Excludes: separate purchases of spare parts,
accessories or lubricants made by households
with the intention of undertaking the maintenance or repair themselves (07.2.1) or
(07.2.2); roadworthiness tests (07.2.4).
07.2.4 Other services in respect of personaltransport
equipment (S)
– Hire of garages or parking spaces not providing parking in connection with the dwelling;
– toll facilities (bridges, tunnels, shuttle ferries,
motorways) and parking meters;
...
personal transport equipment (12.5.4).
07.3 TRANSPORT SERVICES
Purchases of transport services are generally
classified by mode of transport. When a ticket
covers two or more modes of transport – for
example, intra-urban bus and underground or
inter-urban train and ferry – and the expenditure cannot be apportioned between them, then
such purchases should be classified in (07.3.5).
Costs of meals, snacks, drinks, refreshments
or accommodation services have to be included
if covered by the fare and not separately priced.
If separately priced, these costs have to be
classified in Division 11.
School transport services are included, but
ambulance services are excluded (06.2.3).
...
– Transport of individuals and groups of persons and luggage by bus, coach, taxi and
...
07.3.4 Passenger transport by sea and inland waterway
(S)
– Transport of individuals and groups of persons and luggage by ship, boat, ferry,
hovercraft and hydrofoil.
Includes: transport of private vehicles.
07.3.5 Combined passenger transport (S)
– Transport of individuals and groups of persons and luggage by two or more modes of
transport when the expenditure cannot be
...
– travel agents’ commissions, if separately
priced.
Excludes: cable-car and chairlift transport at
ski resorts and holiday centres (09.4.1).
08 COMMUNICATION
08.1 POSTAL SERVICES
08.1.0 Postalservices (S)
– Payments for the delivery of letters, postcards and parcels;
– private mail and parcel delivery.
Includes: all purchases of new postage stamps,
...
telefax machines, telephone-answering
machines and telephone loudspeakers;
– repair of such equipment.
Excludes: telefax and telephone-answering
facilities provided by personal computers
(09.1.3).
08.3 TELEPHONE AND TELEFAX SERVICES
...
public line (public telephone box, post office
cabin, etc.); telephone calls from hotels,
cafe´s, restaurants and the like;
– telegraphy, telex and telefax services;
– information transmission services; Internet
connection services;
– hire of telephones, telefax machines, telephone-answering machines and telephone
loudspeakers.
Includes: radio-telephony, radio-telegraphy
and radiotelex services.
09 RECREATION AND CULTURE
...
recorders, television aerials of all types;
...
cassette players and recorders, CD-players,
personal stereos, stereo systems and their
constituent units (turntables, tuners, amplifiers, speakers, etc.), microphones and earphones.
Excludes: video cameras, camcorders and
sound-recording cameras (09.1.2).
09.1.2 Photographic and cinematographic equipment
and opticalinstruments (D)
– Still cameras, movie cameras and soundrecording cameras, video cameras and camcorders, film and slide projectors, enlargers
and film processing equipment, accessories
(screens, viewers, lenses, flash attachments,
filters, exposure meters, etc.);
– binoculars, microscopes, telescopes and
compasses.
09.1.3 Information processing equipment (D)
– Personal computers, visual display units,
printers and miscellaneous accessories
accompanying them; computer software
packages such as operating systems, applications, languages, etc.;
– calculators, including pocket calculators;
– typewriters and word processors.
Includes: telefax and telephone-answering
facilities provided by personal computers.
Excludes: pre-recorded diskettes and CDROMs containing books, dictionaries, encyclopaedias, foreign language trainers, multimedia presentations, etc. in the form of software (09.1.4); video game software (09.3.1);
video game computers that plug into a television set (09.3.1); typewriter ribbons (09.5.4);
toner and ink cartridges (09.5.4); slide rules
(09.5.4).
09.1.4 Recording media (SD)
– Records and compact discs;
– pre-recorded tapes, cassettes, video cassettes,
diskettes and CD-ROMs for tape recorders,
cassette recorders, video recorders and personal computers;
– unrecorded tapes, cassettes, video cassettes,
diskettes and CD-ROMs for tape recorders,
cassette recorders, video recorders and personal computers;
– unexposed films, cartridges and disks for
photographic and cinematographic use.
Includes: pre-recorded tapes and compact discs
of novels, plays, poetry, etc.; pre-recorded diskettes and CD-ROMs containing books, dictionaries, encyclopaedias, foreign language
trainers, multimedia presentations, etc. in the
form of software; photographic supplies such
as paper and flashbulbs; unexposed film the
price of which includes the cost of processing
without separately identifying it.
Excludes: batteries (05.5.2); computer software
packages such as operating systems, applications, languages, etc. (09.1.3); video game
software, video game cassettes and video game
CD-ROMs (09.3.1); development of films and
...
covered).
Excludes: separate purchases of materials made
by households with the intention of undertaking the repair themselves (09.1.1), (09.1.2)
or (09.1.3).
09.2 OTHER MAJOR DURABLES FOR
RECREATION AND CULTURE
09.2.1 Major durables for outdoor recreation (D)
– Camper vans, caravans and trailers;
– aeroplanes, microlight aircraft, gliders,
hang-gliders and hot-air balloons;
– boats, outboard motors, sails, rigging and
superstructures;
– horses and ponies, horse- or pony-drawn
vehicles and related equipment (harnesses,
bridles, reins, saddles, etc.);
– major items for games and sport such as
canoes, kayaks, windsurfing boards, seadiving equipment and golf carts.
Includes: fitting out of boats, camper vans,
caravans, etc.
Excludes: horses and ponies, horse- or ponydrawn vehicles and related equipment purchased for personal transport (07.1.4); inflatable boats, rafts and swimming pools for
children and the beach (09.3.2).
09.2.2 Musicalinstruments and major durables for
indoor recreation (D)
– Musical instruments of all sizes, including
electronic musical instruments, such as
pianos, organs, violins, guitars, drums,
trumpets, clarinets, flutes, recorders, harmonicas, etc.;
– billiard tables, ping-pong tables, pinball
machines, gaming machines, etc.
Excludes: toys (09.3.1).
09.2.3 Maintenance and repair of other major durables
for recreation and culture (S)
– Maintenance and repair of other major
durables for recreation and culture.
Includes: total value of the service (that is, both
the cost of labour and the cost of materials are
covered); laying up for winter of boats, camper
vans, caravans, etc.; hangar services for private
planes; marina services for boats; veterinary
and other services (stabling, feeding, farriery,
etc.) for horses and ponies purchased for
recreational purposes.
Excludes: fuel for recreational vehicles (07.2.2);
separate purchases of materials made by
households with the intention of undertaking
the maintenance or repair themselves (09.2.1)
or (09.2.2); veterinary and other services for
pets (09.3.5).
09.3 OTHER RECREATIONAL ITEMS AND
EQUIPMENT, GARDENS AND PETS
09.3.1 Games, toys and hobbies (SD)
– Card games, parlour games, chess sets and
the like;
– toys of all kinds including dolls, soft toys,
toy cars and trains, toy bicycles and tricycles,
toy construction sets, puzzles, plasticine,
electronic games, masks, disguises, jokes,
novelties, fireworks and rockets, festoons
and Christmas tree decorations;
– stamp-collecting requisites (used or cancelled
postage stamps, stamp albums, etc.), other
items for collections (coins, medals, minerals, zoological and botanical specimens, etc.)
and other tools and articles n.e.c. for hobbies.
Includes: video-game software; video-game
computers that plug into a television set; videogame cassettes and video-game CD-ROMs.
Excludes: collectors’ items falling into the
category of works of art or antiques (05.1.1);
unused postage stamps (08.1.0); Christmas
trees (09.3.3); children’s scrapbooks (09.5.1).
09.3.2 Equipment for sport, camping and open-air
recreation (SD)
– Gymnastic, physical education and sport
equipment such as balls, shuttlecocks, nets,
rackets, bats, skis, golf clubs, foils, sabres,
poles, weights, discuses, javelins, dumb-bells,
chest expanders and other body-building
equipment;
– parachutes and other sky-diving equipment;
– firearms and ammunition for hunting, sport
and personal protection;
– fishing rods and other equipment for fishing;
– equipment for beach and open-air games,
such as bowls, croquet, frisbee, volleyball,
and inflatable boats, rafts and swimming
pools;
– camping equipment such as tents and
accessories, sleeping bags, backpacks, air
mattresses and inflating pumps, camping
stoves and barbecues;
– repair of such articles.
Includes: game-specific footwear (ski boots,
football boots, golfing shoes and other such
footwear fitted with ice-skates, rollers, spikes,
studs, etc.); protective headgear for sports;
other protective gear for sports such as life
jackets, boxing gloves, body padding, shinguards, goggles, belts, supports, etc.
Excludes: crash helmets for motor cycles and
bicycles (03.1.3); camping and garden furniture
(05.1.1).
09.3.3 Gardens, plants and flowers (ND)
– Natural or artificial flowers and foliage,
plants, shrubs, bulbs, tubers, seeds, fertilizers, composts, garden peat, turf for lawns,
specially treated soils for ornamental gardens, horticultural preparations, pots and
pot holders.
Includes: natural and artificial Christmas trees;
delivery charges for flowers and plants.
Excludes: gardening gloves (03.1.3); gardening
services (04.4.4) or (05.6.2); gardening equipment (05.5.1); gardening tools (05.5.2); insecticides and pesticides for household use
(05.6.1).
09.3.4 Pets and related products (ND)
– Pets, pet foods, veterinary and grooming
products for pets, collars, leashes, kennels,
birdcages, fish tanks, cat litter, etc.
Excludes: horses and ponies (07.1.4) or
(09.2.1); veterinary services (09.3.5).
09.3.5 Veterinary and other services for pets (S)
– Veterinary and other services for pets such as
grooming, boarding, tattooing and training.
Excludes: veterinary and other services (stabling, farriery, etc.) for horses and ponies
purchased for recreational purposes (09.2.3).
09.4 RECREATIONAL AND CULTURAL SERVICES
09.4.1 Recreationaland sporting services (S)
– Services provided by:
- sports stadiums, horse-racing courses,
motor-racing circuits, velodromes, etc.;
- skating rinks, swimming pools, golf courses, gymnasia, fitness centres, tennis
courts, squash courts and bowling alleys;
- fairgrounds and amusement parks;
- roundabouts, see-saws and other playground facilities for children;
- pin-ball machines and other games for
adults other than games of chance;
- ski slopes, ski lifts and the like;
– hire of equipment and accessories for
sport and recreation, such as aeroplanes,
boats, horses, skiing and camping equipment;
– out-of-school individual or group lessons in
bridge, chess, aerobics, dancing, music,
skating, skiing, swimming or other pastimes;
– services of mountain guides, tour guides,
etc.;
– navigational aid services for boating.
Includes: hire of game-specific footwear (ski
boots, football boots, golfing shoes and other
such footwear fitted with ice-skates, rollers,
spikes, studs, etc.).
...
halls, music halls, circuses, sound and light
shows;
...
developing, print processing, enlarging,
...
– Service charges for lotteries, bookmakers,
totalizators, casinos and other gambling
establishments, gaming machines, bingo
halls, scratch cards, sweepstakes, etc. (Service charge is defined as the difference
between the amounts paid for lottery tickets
...
bookbinding.
Excludes: pre-recorded tapes and compact
discs of novels, plays, poetry, etc. (09.1.4); prerecorded diskettes and CD-ROMs containing
books, dictionaries, encyclopaedias, foreign
language trainers, etc. in the form of software
(09.1.4); stamp albums (09.3.1).
...
etc.;
– stencils, carbon paper, typewriter ribbons,
inking pads, correcting fluids, etc.;
– paper punches, paper cutters, paper scissors,
office glues and adhesives, staplers and staples, paper clips, drawing pins, etc.;
– drawing and painting materials such as canvas, paper, card, paints, crayons, pastels and
brushes.
Includes: toner and ink cartridges; educational
materials such as exercise books, slide rules,
geometry instruments, slates, chalks and pencil
boxes.
Excludes: pocket calculators (09.1.3).
09.6 PACKAGE HOLIDAYS
09.6.0 Package holidays (S)
– All-inclusive holidays or tours which provide
for travel, food, accommodation, guides, etc.
Includes: half-day and one-day excursion tours;
pilgrimages.
10 EDUCATION
This division covers educational services
only. It does not include expenditures on educational materials, such as books (09.5.1) and
stationery (09.5.4), or education support services, such as health-care services (06), transport services (07.3), catering services (11.1.2)
and accommodation services (11.2.0).
It includes education by radio or television
broadcasting.
The breakdown of educational services is
based upon the level categories of the 1997
International Standard Classification of Education (ISCED-97) of the United Nations
Educational, Scientific and Cultural Organization (UNESCO).
10.1 PRE-PRIMARY AND PRIMARY EDUCATION
10.1.0 Pre-primary and primary education (S)
– Levels 0 and 1 of ISCED-97: pre-primary
and primary education.
Includes: literacy programmes for students too
...
Includes: out-of-school secondary education
for adults and young people.
10.3 POST-SECONDARY NON-TERTIARY
EDUCATION
10.3.0 Post-secondary non-tertiary education (S)
– Level 4 of ISCED-97: post-secondary nontertiary education.
Includes: out-of-school post-secondary nontertiary education for adults and young people.
10.4 TERTIARY EDUCATION
10.4.0 Tertiary education (S)
– Levels 5and 6 of ISCED-97: first stage and
second stage of tertiary education.
10.5 EDUCATION NOT DEFINABLE BY
LEVEL
10.5.0 Education not definable by level (S)
– Educational programmes, generally for
adults, which do not require any special
prior instruction, in particular vocational
training and cultural development.
Excludes: driving lessons (07.2.4); recreational
training courses such as sport or bridge lessons
given by independent teachers (09.4.1).
11 RESTAURANTS AND HOTELS
11.1 CATERING SERVICES
11.1.1 Restaurants, cafe´s and the like (S)
– Catering services (meals, snacks, drinks and
refreshments) provided by restaurants, cafe´s,
buffets, bars, tearooms, etc., including those
provided:
- in places providing recreational, cultural,
sporting or entertainment services: theatres,
...
for immediate consumption by kiosks,
street vendors and the like, including food
products and beverages dispensed ready
for consumption by automatic vending
machines;
- the sale of cooked dishes by restaurants
for consumption off their premises;
- the sale of cooked dishes by catering
...
11.1.2 Canteens (S)
– Catering services of works canteens, office
...
camping and caravan sites, youth hostels
and mountain chalets;
- boarding schools, universities and other
educational establishments;
- public transport (trains, boats, etc.) when
priced separately;
...
households for a secondary residence for the
duration of a holiday (04.1.2); telephone calls
(08.3.0); catering services in such establishments except for breakfast or other meals
included in the price of the accommodation
(11.1.1); housing in orphanages, homes for
disabled or maladjusted persons (12.4.0).
12 MISCELLANEOUS GOODS AND
SERVICES
12.1 PERSONAL CARE
12.1.1 Hairdressing salons and personal grooming
establishments (S)
– Services of hairdressing salons, barbers,
beauty shops, manicures, pedicures, Turkish
baths, saunas, solariums, non-medical massages, etc.
...
and hood hairdryers, curling tongs and styling combs, sunlamps, vibrators, electric
toothbrushes and other electric appliances
for dental hygiene, etc.;
– repair of such appliances.
12.1.3 Other appliances, articles and products for personalcare (ND)
– Non-electric appliances: razors and hair
trimmers and blades therefor, scissors, nail
files, combs, shaving brushes, hairbrushes,
toothbrushes, nail brushes, hairpins, curlers,
personal weighing machines, baby scales,
etc.;
– articles for personal hygiene: toilet soap,
medicinal soap, cleansing oil and milk,
shaving soap, shaving cream and foam,
toothpaste, etc.;
– beauty products: lipstick, nail varnish, makeup and make-up removal products (including
powder compacts, brushes and powder
puffs), hair lacquers and lotions, pre-shave
and after-shave products, sunbathing products, hair removers, perfumes and toilet
waters, personal deodorants, bath products,
etc.;
– other products: toilet paper, paper handkerchiefs, paper towels, sanitary towels,
cotton wool, cotton tops, babies’ napkins,
toilet sponges, etc.
Excludes: handkerchiefs made of fabric
(03.1.3).
12.2 PROSTITUTION
...
fashioned out of such stones and metals;
– costume jewellery, cuff links and tiepins;
– clocks, watches, stopwatches, alarm clocks,
travel clocks;
– repair of such articles.
Excludes: ornaments (05.1.1) or (05.4.0); radio
clocks (09.1.1); precious stones and metals and
jewellery fashioned out of such stones and
metals acquired primarily as stores of value
(capital formation).
12.3.2 Other personaleffects (SD)
– Travel goods and other carriers of personal
effects: suitcases, trunks, travel bags, attache´
cases, satchels, hand-bags, wallets, purses,
etc.;
– articles for babies: baby carriages, pushchairs, carrycots, recliners, car beds and
seats, back-carriers, front carriers, reins and
harnesses, etc.;
– articles for smokers: pipes, lighters, cigarette cases, cigar cutters, ashtrays, etc.;
– miscellaneous personal articles: sunglasses,
walking sticks and canes, umbrellas and
parasols, fans, keyrings, etc.;
– funerary articles: coffins, gravestones, urns,
etc.;
– repair of such articles.
Includes: lighter fuel; wall thermometers and
barometers.
Excludes: baby furniture (05.1.1); shopping
bags (05.2.0); feeding bottles (05.4.0).
12.4 SOCIAL PROTECTION
Social protection as defined here covers
assistance and support services provided to
persons who are: elderly, disabled, having
occupational injuries and diseases, survivors,
unemployed, destitute, homeless, low-income
earners, indigenous people, immigrants, refugees, alcohol and substance abusers, etc. It also
covers assistance and support services provided
to families and children.
12.4.0 Socialprotection (S)
Such services include residential care, home
help, day care and rehabilitation. More specifically, this class covers payments by households for:
– Retirement homes for elderly persons, residences for disabled persons, rehabilitation
centres providing long-term support for
patients rather than health care and rehabilitative therapy, schools for disabled persons
where the main aim is to help students
...
– wet-nurses, cre`ches, play schools and other
child-minding facilities;
– counselling, guidance, arbitration, fostering
and adoption services for families.
12.5 INSURANCE
Service charges for insurance are classified by type of insurance, namely: life insurance and non-life insurance (that is, insurance
in connection with the dwelling, health, transport, etc.). Service charges for multi-risk
insurance covering several risks should be
classified on the basis of the cost of the
principal risk if it is not possible to allocate
the service charges to the various risks
covered.

Service charge is defined as the difference
between claims due and premiums earned and
premium supplement.
12.5.1 Life insurance (S)
– Service charges for life assurance, death
benefit assurance, education assurance, etc.
12.5.2 Insurance connected with the dwelling (S)
– Service charges paid by owner-occupiers and
by tenants for the kinds of insurance typically taken out by tenants against fire, theft,
water damage, etc.
Excludes: service charges paid by owner-occupiers for the kinds of insurance typically taken
out by landlords (intermediate consumption).
12.5.3 Insurance connected with health (S)
– Service charges for private sickness and
accident insurance.
12.5.4 Insurance connected with transport (S)
– Service charges for insurance in respect of
personal transport equipment;
– service charges for travel insurance and
luggage insurance.
12.5.5 Other insurance (S)
– Service charges for other insurance such as
civil liability for injury or damage to third
parties or their property.
Excludes: civil liability or damage to third parties or their property arising from the operation
of personal transport equipment (12.5.4).
12.6 FINANCIAL SERVICES N.E.C.
12.6.1 FISIM (S)
– Financial intermediation services indirectly
measured.
12.6.2 Other financialservices n.e.c. (S)
– Actual charges for the financial services of
banks, post offices, saving banks, money
changers and similar financial institutions;
...
etc.;
– charges for undertaking and other funeral
services;
– payment for the services of estate
agents, housing agents, auctioneers, salesroom operators and other intermediaries;
– payment for photocopies and other reproductions of documents;
– fees for the issue of birth, marriage and
